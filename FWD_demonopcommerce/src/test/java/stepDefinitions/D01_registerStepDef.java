...
public class D01_registerStepDef {
    ...
    {
        p01_register.rgBtnTskBar.click();
    }
    ...
    public void userFillsTheAndFields(String arg0, String arg1) {
        SoftAssert softAssert = new SoftAssert();
        p01_register.fillFrtandLstNm(arg0 , arg1);

        if(arg0.equals("") || arg1.equals(""))
        {
            p01_register.rgBtn.click();
            softAssert.assertTrue((arg0.equals(""))&&(p01_register.rgfrtNameError.isDisplayed()),
                    "the message \"First name is required\" is not Displayed");
            softAssert.assertTrue((arg1.equals(""))&&(p01_register.rglstNameError.isDisplayed()),
...
//
    ...
    public void userSuccessfullyRegistersInTheWebsite() {
        ...
        softAssert.assertTrue(p01_register.rgSuccess.isDisplayed(),"the message \"Your registration completed\" is not displayed");
    ...
    public void userClicksTheContinueButton() {
        p01_register.rgContinueBtn.click();
    }
